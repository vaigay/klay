...
function loadEnv() {
    ...
    nodeApiUrl = nodeApiUrl === '' ? process.env.NODE_API_URL : nodeApiUrl
    accessKeyId = accessKeyId === '' ? process.env.ACCESS_KEY_ID : accessKeyId
    secretAccessKey = secretAccessKey === '' ? process.env.SECRET_ACCESS_KEY : secretAccessKey
    chainId = chainId === '' ? process.env.CHAIN_ID : chainId
    senderAddress = senderAddress === '' ? process.env.SENDER_ADDRESS : senderAddress
    senderPrivateKey = senderPrivateKey === '' ? process.env.SENDER_PRIVATE_KEY : senderPrivateKey
    recipientAddress = recipientAddress === '' ? process.env.RECIPIENT_ADDRESS : recipientAddress
}
